...
const ProductDetail = () => {
    ...
    return (
        <>
            <div className='w-full border py-6 px-2'>
                <div className='xl:w-[80%] lg:w-[85%] sm:w-[95%] w-full m-auto sm:flex gap-[15px]'>
                    <div className="sm:w-[40%] flex flex-col-reverse sm:flex-row gap-2 justify-between ">
                        ...
                        <div className='sm:w-[80%] w-full rounded-md shadow-lg h-[300px] md:h-auto'>
                            <img src={product1} alt="product Image" className='w-full h-full rounded-md shadow-lg' />
                        </div>
                    </div>
                    <div className='w-full sm:w-[56%] px-2 text-gray-600'>
                        <h1 className='text-2xl font-semibold '>Women in pure cotton saree</h1>
                        ...
                        <div className='mt-2 text-lg flex gap-4 font-semibold'>
                            <span>$29.99</span>
                        ...
                        <p className='mt-2 mb-3'> Free Shipping over $39.99 (Est Delivery in 2-3 days)</p>
                        ...
                        <Button className='!mt-2 !flex !gap-2 !curosr-pointer'>
                            <FaRegHeart />
                            Add to wishlist
                        </Button>
                    </div>
