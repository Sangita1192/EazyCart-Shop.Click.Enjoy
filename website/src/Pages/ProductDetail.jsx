                        ...
                        <div className='xl:w-[80%] lg:w-[85%] sm:w-[95%] w-full m-auto sm:flex gap-[15px] xl:gap-[25px]'>
                            ...
                            <div className='w-full sm:w-[56%] px-2 text-gray-600'>
                                        ...
                                        <div className="flex gap-2 overflow-x-auto size-color-scroller">
                                            {product?.size?.map((s) => (
                                                <button
                                                    ...
                                                    className={`px-3 py-1 rounded-lg text-sm border cursor-pointer ${selectedSize == s
                                ...
                                <div className='flex gap-4'>
                                    ...
                                    <Button
                                        className="!flex !gap-2 !justify-center !items-center !bg-amber-600 hover:!bg-amber-700 !text-white !px-[15px]"
                                        onClick={() => {
                                            if (variantItem) {
                                                updateQuantity(localQty);
                                            } else {
                                                addToCart();
                                            }
                                        }}
                                    >
                                        ...
                                        {variantItem ? 'Update Cart' : 'Add to Cart'}
                                    </Button>
                                </div>
                                {variantItem && (
                                    <span className="text-green-600/60 text-sm">
                                         ✔ Already in your cart ({variantItem.quantity})
                                    </span>
                                )}
                                <Button
                                    className={`!mt-2 !flex !gap-2 !curosr-pointer xl:!mt-4 !border ${isInWishlist ? "!border-[red]" : "!border-[gray]"}`}
