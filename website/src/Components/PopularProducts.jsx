...
const PopularProducts = () => {
    ...
    return (
        <>
            <div className='border border-1 bg-[white] md:p-[15px] p-[10px] py-[25px]'>
                <div className='w-full lg:w-[95%] m-auto py-[10px]'>
                            ...
                            {tabs.map((tab) => (
                                <li key={tab}>
                                    <button
                                        ...
                                        className={`pb-2 px-[15px] transition-all duration-200 font-semibold border-b-2 ${activeTab === tab
                    ...
                    {/* <div className='border py-[10px] my-[15px] grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[15px]'>
                            <ProductItem/>
                            <ProductItem/>
                            <ProductItem/>
                            <ProductItem/>
