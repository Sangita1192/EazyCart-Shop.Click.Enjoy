                                        ...
                                        <tr className="hover:bg-[#FFF3E8]" key={product._id}>
                                            ...
                                            <td className="px-4 py-3 flex gap-1 justify-between mr-1">
                                                {product.images.map(img => (
                                                    <img src={img} alt="product Image" className="w-[70px] h-[50px] rounded object-cover" />
                                                ))}
                                            </td>
                                            ...
                                            <td className="px-4 py-3 align-top">
                                                <Tooltip title={`Click to mark as ${product.isFeatured ? "No" : "Yes"}`}>
                                                    <button
                                                        // onClick={() => handleStatus(category._id, category.status)}
                                                        className={`text-white px-3 py-1 rounded-md capitalize cursor-pointer 
                                                        ${product.isFeatured ? "bg-emerald-500 hover:bg-emerald-600" : "bg-red-500 hover:bg-red-600"}`}
                                                    >
