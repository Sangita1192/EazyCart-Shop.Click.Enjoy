  ...
  return (
    <div className="rounded-[8px] my-[15px] border border-gray-200 shadow-lg bg-white p-5">
      ...
      <div className="my-[25px] flex flex-col gap-[5px] relative">
        ...
        <input type="text" id="name" className="bg-[#f1f1f1] px-[15px] py-[10px] rounded-md focus:outline-blue-600" placeholder="Category Name" />
      </div>
      <div className="my-[25px] flex flex-col gap-[5px] relative">
        <label htmlFor="slug" className="mb-2 font-semibold">Category Name</label>
        <input type="text"  id="slug" className="bg-[#f1f1f1] px-[15px] py-[10px] rounded-md focus:outline-blue-600" placeholder="Category Name" />
      </div>
